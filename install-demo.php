...
$sqlToInsertInteresseQuery = "INSERT INTO Interesse (interesseId, nome) VALUES (21, 'SPORT');
                                INSERT INTO Interesse (interesseId, nome) VALUES(22, 'CUCINARE');
                                INSERT INTO Interesse (interesseId, nome) VALUES(23, 'GIARDINAGGIO');
                                INSERT INTO Interesse (interesseId, nome) VALUES(24, 'LEGGERE');
                                INSERT INTO Interesse (interesseId, nome) VALUES(25, 'DISEGNARE');";

$conn->exec($sqlToInsertInteresseQuery);


$sql3 = "use $dbname;

        CREATE table if not exists interesse_user (
            interesseId int(10) NOT NULL EXTERNAL KEY,
            userId int(10) NOT NULL EXTERNAL KEY
            )";
